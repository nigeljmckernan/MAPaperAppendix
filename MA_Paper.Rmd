...
data_hourly <- data.table::fread("C:\\Users\\nigel\\Nigel's Documents\\MA Project\\data_hourly.csv") %>% as_tibble()


stations <- read_csv("C:\\Users\\nigel\\Nigel's Documents\\MA Project\\station_data.csv")
...
pollution <- read_csv("C:\\Users\nigel\\Nigel's Documents\\MA Project\\Data_Date.csv")
```
...
pollution <- read_csv("C:\\Users\\nigel\\Nigel's Documents\\MA Project\\Data_Date.csv") %>% pdata.frame(index = c("City",
                                                                   "Date"))
```
...
```{r weak instrument direction, results='asis'}
...
```{r weak instrument speed, results='asis'}
...
```{r compare single IV models, results='asis'}
